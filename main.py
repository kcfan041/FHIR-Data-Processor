...
def check_and_build():
    ...
    if not os.path.exists("./setting/ex.json"):
        ...
        if enable_meta_data:
            ex["Patient"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/ServiceRequest-sport"]}
            ex["height"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/Height-sport"]}
            ex["weight"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/Weight-sport"]}
            ex["waist"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/Waist-sport"]}
            ex["bloodpressure"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/BloodPressure-sport"]}
            ex["SpO2"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/SpO2-sport"]}
            ex["glucose"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/Glucose-sport"]}
            ex["heartrate"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/HeartRate-sport"]}
            ex["restingheartrate"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/RestingHeartRate-sport"]}
            ex["meanheartrate"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/MeanHeartRate-sport"]}
            ex["heartratevariability"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/HRV-sport"]}
            ex["temperature"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/BodyTemperature-sport"]}
            ex["respiratoryrate"]["meta"] = {"profile":["https://kcfhir.dicom.tw/fhir/StructureDefinition/RespiratoryRate-sport"]}
